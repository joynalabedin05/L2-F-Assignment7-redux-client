...
const EndToEndService = () => {
    ...
    return (
        <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold ">Unique Management</h1>
                <p className="m-3 my-5 md:w-3/4 md:mx-auto">Maersk provides a range of integrated supply chain and logistics products designed to meet the needs of all types of businesses. Contact us today and learn how.</p>
                
            </div>
            <div className={` ${darkMode ? "bg-black text-white" : "bg-gray-50"} p-5 md:p-7 rounded md:mt-10`}>
            <div className="mt-5">
